...
SELECT DISTINCT   
  ...
  , MONF.*  
	 FROM 
(
SELECT DISTINCT O.DATA_OCORRENCIA			
	, (CASE WHEN O.RESPONSAVEL IS NULL THEN 'NÃO TRATADO'ELSE O.DESCRICAO_OCOR END) AS  OCORRÊNICIA
	, O.CODIGO_OCOR
	, O.RESPONSAVEL AS REPONSAVEL_OCOR
	, M.*	
