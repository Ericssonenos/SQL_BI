/*GERAL PERFORMANCE OLHE PARA A DATA !*/
...
SELECT 
	...
	FROM	
			...
			,(CASE 		
				...
				WHEN DRECE.CPF_PROPRIETARIO IS NOT NULL AND DMC02.DT_ENTREGA IS NOT NULL THEN 'DISTRIBUIÇÃO'
			...
			,(CASE 		
				...
				WHEN DRECE.CPF_PROPRIETARIO IS NOT NULL AND DMC02.DT_ENTREGA IS NOT NULL THEN VCC.PLACA_PRINCIPAL
			...
			,DMC02.NR_ENTRADA
		FROM
			(SELECT DISTINCT  dbo.fn_ret_notas_cte(DMCE01.NR_ENTRADA, DMCE01.SIGLA_FIL) AS NOTA_AGRUP , DMCE01.* FROM   tb_dados_movimento_custo_emis AS DMCE01 WHERE DMCE01.TIPO_DOC IN('NF','CO') AND DMCE01.PREVISAO_ENTREGA >= '20190630' and DMCE01.PREVISAO_ENTREGA <= '20191231' ) DMC02
		LEFT JOIN 
