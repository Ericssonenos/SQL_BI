SELECT DISTINCT 
	...
	FROM	
			...
			,(CASE 
				...
				END)	AS DIAS_ATRASO
			,(DATEDIFF(hh,SO03.DATA_OCORRENCIA,  GETDATE()))-(DATEDIFF(wk, SO03.DATA_OCORRENCIA, GETDATE()) * 48)-(CASE WHEN DATEPART(dw,  GETDATE()) = 1 THEN 24 ELSE 0 END)-(CASE WHEN DATEPART(dw, GETDATE()) = 7 THEN 24 ELSE 0 END) AS horas_OCORRENCIA
