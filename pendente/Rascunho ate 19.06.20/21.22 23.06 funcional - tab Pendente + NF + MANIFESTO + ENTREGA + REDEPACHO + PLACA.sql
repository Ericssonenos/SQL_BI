SELECT DISTINCT
	...
	,MNFE.FIL_BAIXA_MNF
	  ,(CASE
		...
		WHEN MNFE.DT_CHEGADA IS NULL THEN PL2.PLACA_PRINCIPAL
...
LEFT JOIN Tb_valores_contrato_custo AS PL2
	ON 	concat(cast(MNFE.NUM_CONTRATO AS char) , MNFE.FIL_CONTRATO) = concat(cast(PL2.NUM_CONTRATO as CHAR), PL2.FIL_CONTRATO)
LEFT JOIN 
